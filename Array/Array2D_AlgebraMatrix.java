...
public class Array2D_AlgebraMatrix {
	...
	public static void main(final String[] args) {
		...
		/*
		 * Arnob Mahmud suggests you to change the row & column value and then multiply
		 * them
		 */

		// When the amount of fist matrix's column will be equaled to second matrix's
		// row then two matrix will be able to multiplied
